...
public enum OptionParam {
    ...
    BACKGROUND_MAP_VISIBILITY(Option.BACKGROUND_MAP_VISIBILITY,
                              false,
                              () -> Optional.of("2233.56"),
                              (factory) -> Math.abs(factory.getConfiguration().getBackgroundMapVisibility() - 2233.56F) < .0000001),
    COLOR(Option.COLOR,
          true,
          () -> Optional.of(TEST_COLOR_FF_0096),
    ...
    FPS(Option.FPS,
        false,
        () -> Optional.of("244.6"),
        (factory) -> Math.abs(factory.getConfiguration().getFps() - 244.6D) < .0000001),
    ...
    PHOTO_FREEZE_FRAME_TIME(Option.PHOTO_FREEZE_FRAME_TIME,
            false,
            () -> Optional.of("500"),
            (factory) -> factory.getConfiguration().getPhotoFreezeFrameTime().equals(500L)),
    ...
    PREVIEW(Option.PREVIEW,
                   false,
                   () -> Optional.of("true"),
                   (factory) -> factory.getConfiguration().isPreview()),
